...
public class AppMain {
	...
	// This Method Is Used To Load The Spring Bean Configuration File And Return The
	// 'BeanFactory' Object
	...
	// This Is The Main Method And In Here We Are Retrieving The Spring Bean via
	// 'getBean()' Method
